    ...
    return (
        <div className="flex justify-center">
            <div className="inline-block rounded-lg t bg-gray-200 m-4 ">
                ...
                <button type="button" class="float-right m-4 bg-neutral-300 rounded-md py-2 px-4 inline-flex items-center justify-center text-white hover:text-gray-400 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500">
