            ...
            <div className="inline-block rounded-lg t bg-gray-200 m-4 ">
                ...
                <form >
                    <div className="grid grid-cols-2 gap-4 p-4">
                        <label className="p-2 m-2">
                            ชื่อวิชา :
                            <input required placeholder={props.subjectselect.SUB_NAME} className="ml-2" type="text" name="NameSubject" ></input>
                        </label>

                        <label className="p-2 m-2">
                            รหัสวิชา :
                            <input required placeholder={props.subjectselect.SUB_ID} className="ml-2" type="text" name="SubjectID" />
                        </label>

                        <label className="p-2 m-2">
                            ชื่ออาจารย์ :
                            <input required placeholder={props.subjectselect.SUB_PROF} className="ml-2" type="text" name="ProfName" />
                        </label>

                        <label className="p-2 m-2">
                            Quota :
                            <input required placeholder={props.subjectselect.SUB_} className="ml-2" type="text" name="Quota" />
                        </label>
                        <form >
                            <div className="grid grid-cols-2 ">
                                <label className="p-2 m-2">
                                    ภาคชุมนุม :
                                    <input required className="m-2 p-2" type="radio" name="CHUMNUM" />
                                </label>

                                <label className="p-2 m-2">
                                    ภาคเสรี :
                                    <input required className="m-2 p-2" type="radio" name="FREE" />
                                </label>
                            </div>
                ...
                <form className="m-2 px-4 pt-2" >
                    <div className="grid grid-cols-3">
                        <label>
                            มัธยมศึกษาปีที่ 1 :
                            <input className="m-2 p-2" type="checkbox" name="M.1" />
                        </label>

                        <label >
                            มัธยมศึกษาปีที่ 2 :
                            <input className="ml-2 pl-2" type="checkbox" name="M.2" />
                        </label>
                        <label>
                            มัธยมศึกษาปีที่ 3 :
                            <input className="m-2 p-2" type="checkbox" name="M.3" />
                        </label>

                        <label>
                            มัธยมศึกษาปีที่ 4 :
                            <input className="m-2 p-2" type="checkbox" name="M.4" />
                        </label>
                        <label>
                            มัธยมศึกษาปีที่ 5 :
                            <input className="m-2 p-2" type="checkbox" name="M.5" />
                        </label>

                        <label>
                            มัธยมศึกษาปีที่ 6 :
                            <input className="m-2 p-2" type="checkbox" name="M.6" />
                        </label>
                    </div>
                </form>
