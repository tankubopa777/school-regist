...
export default function GroupDetail(subjects) {
        ...
        <div className="w-5/6 tablet:w-1/2 ml-10">
            <table className="w-full">
                <div className="flex justify-evenly rounded-lg bg-white shadow-lg border-2 m-2 p-2">
                    ...
                    <tr className="w-1/6 text-xs font-bold break-all p-2 ">{subject[0].SUB_ID}</tr>
                    <tr className="w-1/3 text-xs p-2 break-all">{subject[0].SUB_NAME}</tr>
                    <tr className="w-1/6 text-xs p-2 break-all">{subject[0].STD.length}/{subject[0].SUB_CAP}</tr>
