...
export default function Block_DetailStd(props) {
    ...
    const subject = Object.values(props);
    ...
    //                 <button className="text-[0.5rem] p-0 mobile:text-xs mobile:p-2 font-bold hover:text-green-700 flex flex-col justify-center">ลงทะเบียน</button>
    //             </div>
    //             {show && <div id="detail">
