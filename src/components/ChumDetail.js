...
export default function ChumDetail(props) {
            ...
            <table className="w-full">
                <tbody>
                    <tr className="flex justify-evenly rounded-lg bg-white shadow-lg border-2 m-2 p-2">
                        ...
                        <td className="w-1/4 text-sm tablet:text-xl p-0 tablet:p-1 break-all flex flex-col justify-center truncate max-w-[10rem]">{subject.SUB_NAME} </td>
                    ...
                    {show && <tr id="detail">
                        ...
                        <td className="flex flex-col rounded-lg bg-gray-300 shadow-lg border-2 m-2 p-2">
                            <table>
                                <tbody>
                                    <tr>
                                        <td className="text-sm tablet:text-xl font-bold break-all p-2">ชื่อวิชาชุมนุม : </td>
